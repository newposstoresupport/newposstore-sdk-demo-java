 ...
 */
public class GoInsightAbility extends BaseAbility {

    public GoInsightAbility(String baseUrl, AppElements elements, String serialNumber, List<String> apis) {
