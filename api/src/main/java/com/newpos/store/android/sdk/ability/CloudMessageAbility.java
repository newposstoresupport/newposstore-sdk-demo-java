 ...
 */
public class CloudMessageAbility extends BaseAbility {

    public CloudMessageAbility(String baseUrl, AppElements elements, String serialNumber, List<String> apis) {
